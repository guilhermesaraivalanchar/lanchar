...
(function() {
  ...
  JpegCamera = (function() {
    JpegCamera.DefaultOptions = {
      shutter_ogg_url: "../../javascripts/shutter.ogg",
      shutter_mp3_url: "../../javascripts/shutter.mp3",
      swf_url: "../../javascripts/jpeg_camera.swf",
    ...
    function JpegCamera(container, options) {
      ...
      container.innerHTML = "";
      valor_width = parseInt(container.offsetWidth, 10)
      if (valor_width < 301)
        this.view_width = valor_width
      else
  ...
  if (navigator.getUserMedia) {
    ...
    JpegCameraHtml5 = (function(_super) {
      ...
      JpegCameraHtml5.prototype._engine_init = function() {
        ...
        try {
          return navigator.getUserMedia({ video: true }, success, failure);
        } catch (_error) {
          error = _error;
        ...
        return snapshot.get_blob(function(blob) {
          ...
          var reader = new window.FileReader();
           ...
           reader.onloadend = function() {
                          ...
                          //$("#motorista_foto_motorista_64").val(base64data);
                          console.log("BEDUG _engine_upload - BASE 64");
  ...
  Snapshot = (function() {
    ...
    Snapshot.prototype.upload = function(options) {
      ...
      console.log("THIS DO UPLOAD")
      console.log(this)

      return this.get_blob(function(blob) {
        var handler, xhr;
    ...
    Snapshot.prototype._start_upload = function(cache) {
      ...
      console.log("THIS DO START UPLOAD")
      console.log(this)
      ...
      console.log("START UPLOAD DEBUG - "+cache.api_url)
